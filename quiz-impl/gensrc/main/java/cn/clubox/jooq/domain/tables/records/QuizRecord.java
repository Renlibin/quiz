...
public class QuizRecord extends UpdatableRecordImpl<QuizRecord> implements Record5<Integer, String, String, String, Timestamp> {

    private static final long serialVersionUID = -1880218272;
     ...
     */
    @Override
    public QuizRecord values(Integer value1, String value2, String value3, String value4, Timestamp value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public QuizRecord(Integer id, String title, String description, String status, Timestamp stored) {
        super(Quiz.QUIZ_);
