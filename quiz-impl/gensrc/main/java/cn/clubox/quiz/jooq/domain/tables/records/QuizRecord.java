...
public class QuizRecord extends UpdatableRecordImpl<QuizRecord> implements Record9<Integer, String, String, String, Timestamp, String, String, String, String> {

    private static final long serialVersionUID = -1274476325;
    ...
    /**
     * Setter for <code>quiz.quiz.quiz_src</code>.
     */
    public QuizRecord setQuizSrc(String value) {
        set(8, value);
        return this;
    }

    /**
     * Getter for <code>quiz.quiz.quiz_src</code>.
     */
     ...
     */
    @Override
    public QuizRecord values(Integer value1, String value2, String value3, String value4, Timestamp value5, String value6, String value7, String value8, String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public QuizRecord(Integer id, String title, String description, String status, Timestamp stored, String quizType, String logoSrc, String name, String quizSrc) {
        super(Quiz.QUIZ_);
